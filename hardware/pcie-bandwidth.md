...
| [voipmonitor (ASUS ESC8000A-E13P, Broadcom, ACS off)](asus-esc8000a-e13p-broadcom-switches.md) | 0.84 (52.8 GB/s) | 0.10 (44.2 / 422.5 GB/s) | 7.40 us |

> **Note:** voipmonitor's 8-GPU all-to-all score (0.10) is low because the dual-socket Infinity Fabric saturates under 56 concurrent flows. Ring-based performance is much better — see the [detailed page](asus-esc8000a-e13p-broadcom-switches.md#scores--new-version-ring-based-current-p2pmark) for new-version p2pmark scores (ring interconnect: **0.90**).
...
| [voipmonitor (ASUS ESC8000A-E13P, Broadcom, ACS off)](asus-esc8000a-e13p-broadcom-switches.md) | 0.88 | 0.61 (134.2 / 221.2 GB/s) | 2.12 us |

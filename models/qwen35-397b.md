...
NCCL_P2P_LEVEL=4         # Forces NVLink path. WARNING: If topology doesn't support NVLink, NCCL will deadlock/spin.
...
2. Try removing `NCCL_P2P_LEVEL=4` entirely, use `NCCL_P2P_DISABLE=0` instead
